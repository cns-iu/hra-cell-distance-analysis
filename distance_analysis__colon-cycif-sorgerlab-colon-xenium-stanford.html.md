...
```
    ...
    Top 5 cell types in cycif-sorgerlab:
      Level One Cell Type  mean_distance
    0     epithelial cell      82.147985
    2    mesenchymal cell      68.208556
    1         immune cell      61.678740
    3        unknown cell      60.480321
...
```
    ...
    Top 5 cell types in cycif-sorgerlab:
      Level One Cell Type  median_distance
    0     epithelial cell        74.178224
    2    mesenchymal cell        59.198815
    1         immune cell        50.745512
    3        unknown cell        47.491177
...
```
    ...
    CV: Coefficient of Variation (std/mean * 100%)
                      mean    std  CV (%)
    Unique Region                        
    cycif-sorgerlab  70.98  43.45    61.2
    xenium-stanford  27.85  19.03    68.3

    Cell Type Variability Analysis (sorted by CV):
                          mean    std  CV (%)
    Level One Cell Type                      
    mesenchymal cell     55.82  42.66    76.4
    unknown cell         55.97  42.49    75.9
    neural cell          21.86  16.10    73.7
    immune cell          57.23  41.06    71.7
    epithelial cell      70.71  44.40    62.8
...
```
    ...
    Top 5 cell types in cycif-sorgerlab:
      Level Two Cell Type  mean_distance
    0       abnormal cell      82.147985
    2          fibroblast      68.208556
    1              b cell      64.896625
    3          macrophage      61.429549
    4              t cell      61.239969
...
```
    ...
    Top 5 cell types in cycif-sorgerlab:
      Level Two Cell Type  median_distance
    0       abnormal cell        74.178224
    2          fibroblast        59.198815
    1              b cell        55.307876
    4              t cell        50.232791
    3          macrophage        49.848386
...
```
    ...
    unknown cell                          56.04  42.46    75.8
    fibroblast                            57.93  42.81    73.9
    neuroglial cell                       22.06  16.31    73.9
    adipocyte                             19.31  14.10    73.0
    macrophage                            57.62  41.92    72.8
    t cell                                58.73  41.09    70.0
    b cell                                59.38  40.89    68.9
    ...
    abnormal cell                         82.15  43.47    52.9
...
```
    ...
    Top 5 cell types in cycif-sorgerlab:
                            Level Three Cell Type  mean_distance
    13                            neoplastic cell      82.625204
    1   epithelial cell:ki67+ proliferating tumor      78.360780
    2                 epithelial cell:pdl1+ tumor      75.137143
    12                              myofibroblast      68.208556
    16                                t cell:cd8+      66.644459

    Bottom 5 cell types in cycif-sorgerlab:
       Level Three Cell Type  mean_distance
    14           t cell:cd4+      56.015830
    17     t cell:cd8+ pdl1+      54.296905
    7           macrophage:i      54.285937
    6       lymphocyte:pdl1+      51.562529
    18     t cell:regulatory      50.580213
...
```
    ...
    Top 5 cell types in cycif-sorgerlab:
                            Level Three Cell Type  median_distance
    13                            neoplastic cell        74.671806
    1   epithelial cell:ki67+ proliferating tumor        70.649813
    2                 epithelial cell:pdl1+ tumor        66.782894
    12                              myofibroblast        59.198815
    16                                t cell:cd8+        56.193630

    Bottom 5 cell types in cycif-sorgerlab:
       Level Three Cell Type  median_distance
    14           t cell:cd4+        45.286891
    17     t cell:cd8+ pdl1+        44.521837
    7           macrophage:i        42.311374
    6       lymphocyte:pdl1+        41.812300
    18     t cell:regulatory        41.032061
...
```
    ...
    macrophage:i                               54.29  38.61    71.1
    fibroblast:crypt 4                         19.26  13.53    70.2
    fibroblast:cancer associated               18.84  13.19    70.0
    lymphocyte:double-negative                 57.46  40.12    69.8
    myofibroblast cell:smooth muscle 3         23.68  16.49    69.6
    goblet cell                                33.70  23.37    69.3
    neuron                                     22.68  15.63    68.9
    macrophage:iii                             63.25  43.44    68.7
    lymphocyte:iii                             63.59  43.60    68.6
    t cell:cd4+                                56.02  38.35    68.5
    fibroblast:crypt 3                         21.08  14.39    68.3
    macrophage:ii                              56.75  38.68    68.2
    lymphocyte:pdl1+                           51.56  35.04    68.0
    t cell:cd4+ alpha-beta                     21.07  14.31    67.9
    mast cell                                  18.45  12.51    67.8
    dendritic cell                             19.60  13.26    67.7
    t cell:regulatory                          50.31  33.98    67.5
    macrophage:iv                              63.16  42.46    67.2
    t cell:cd8+ pdl1+                          54.30  36.10    66.5
    t cell:cd8+ alpha-beta effector memory     19.46  12.76    65.6
    transit amplifying cell:proliferating      29.75  19.42    65.3
    t cell:cd8+                                66.64  42.92    64.4
    b cell:memory                              23.93  15.31    64.0
    t cell:cd4+ pdl1+                          60.32  38.52    63.9
    t cell:naive                               21.37  13.53    63.3
    macrophage:pdl1+                           61.94  38.72    62.5
    b cell                                     64.90  40.38    62.2
    myofibroblast                              68.21  42.34    62.1
    ...
    lymphocyte:double-positive alpha-beta      63.29  38.01    60.1
    enteroycte:best4+                          37.29  21.83    58.5
    enterocyte:progenitor                      33.81  19.47    57.6
    goblet cell:immature                       32.75  18.76    57.3
    epithelial cell:pdl1+ tumor                75.14  42.48    56.5
    enterocyte                                 50.88  27.81    54.7
    neoplastic cell                            82.63  43.72    52.9
    stem cell                                  31.43  16.46    52.4
    lymphoid cell:innate                       18.16   9.48    52.2
    epithelial cell:ki67+ proliferating tumor  78.36  40.53    51.7
